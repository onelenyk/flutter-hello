...
class A4PageContainer extends StatelessWidget {
  ...
  A4PageContainer({required this.child, this.color = Colors.transparent});
...
class A4PageWidthContainer extends StatelessWidget {
  // Background color of the container
  A4PageWidthContainer({required this.child, this.color = Colors.transparent});
  ...
  Widget build(final BuildContext context) {
    ...
    return Center(
      child: Container(
          width: pageWidth, color: color, child: Center(child: child)),
    );
  }
}

class A54PageWidthContainer extends StatelessWidget {
  // Background color of the container
  A54PageWidthContainer({required this.child, this.color = Colors.transparent});
